...
def run_alexa():
    ...
    try:
        ...
        if 'hello' in command:
            print('hello tejas how can i helpp you ??')
            engine_talk('hello tejas, how can i help you ??')

        elif 'who are you' in command:
            print('I am mini  a k a your virtual assistant master')
            engine_talk('I am mini a k a your virtual assistant master. how can i help you ??')
            ...
            engine_talk('''i can play songs on youtube , tell you a joke, search on wikipedia, tell date and time,find your location, locate area on map,
                       open different websites like insta gram, youtube,gmail, git hub, stack overflow and searches on google. How may i help you tejas ??''')
            ...
            engine_talk("Tejas You must be somewhere near here, as per Google maps")
            ...
            print('good bye tejas, have a nice day !!')
            engine_talk('good bye tejas, have a nice day !!')
            sys.exit()
...
print('\n')
print("hello tejas, i am mini how can i help you ??")
engine_talk("hello tejas i am mini how can i help you ")
while True:
    run_alexa()
